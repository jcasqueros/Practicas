...
public class StreetItemReader {
    ...
    //Añadir condición para cuando encuentre un error de procesado lo salte y muestre el error.
    public FlatFileItemReader<Street> reader(ResourceLoader resourceLoader) {
        ...
        return new FlatFileItemReaderBuilder<Street>().name("customerItemReader")
                ...
                .names("CODIGO_CALLE", "TIPO_VIA", "NOMBRE_CALLE", "PRIMER_NUM_TRAMO", "ULTIMO_NUM_TRAMO", "BARRIO", "COD_DISTRITO", "NOM_DISTRITO")
                .fieldSetMapper(fieldSerMapper)
                .linesToSkip(1)
                .build();
    }
