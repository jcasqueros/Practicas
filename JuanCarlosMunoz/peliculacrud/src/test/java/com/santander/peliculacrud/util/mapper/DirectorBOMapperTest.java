...
class DirectorBOMapperTest {
    ...
    private final DirectorBOMapper directorBOMapper = Mappers.getMapper(DirectorBOMapper.class);
    ...
    void testListEntityListBo() {
        ...
        List<DirectorBO> directorBOs = directorBOMapper.listEntitytoListBo((Page<Director>) directors);
