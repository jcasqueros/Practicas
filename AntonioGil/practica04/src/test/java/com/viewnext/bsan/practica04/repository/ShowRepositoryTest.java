...
/**
 * Unit test for {@code ShowRepository} (implementation provided by Spring Data JPA).
 *
 * @author Antonio Gil
 */
@DataJpaTest
class ShowRepositoryTest {
    ...
    @Autowired
    public ShowRepositoryTest(ShowRepository repository, TestEntityManager testEntityManager) {
    ...
    void givenInvalidShowData_whenSave_thenThrow() {
        ...
        assertThrows(NestedRuntimeException.class, () -> repository.save(invalidShow));
    }
